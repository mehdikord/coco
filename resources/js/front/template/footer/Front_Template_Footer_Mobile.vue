...
<template>
    <div class="mobile-menu">
        ...
        <router-link :to="{name : 'index'}" title="Home Page" class="pt-3 text-success" >
            <i class="fas fa-home font-20"></i><span>کوکوکافی</span>
        </router-link>
        <button class="cate-btn pt-3" title="Category List">
            <i class="fas fa-shopping-cart font-20"></i><span>محصولات</span>
        </button>
...
export default defineComponent({
    name: "Front_Template_Footer_Mobile"
})
</script>
